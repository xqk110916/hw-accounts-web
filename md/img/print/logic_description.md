...
| 材料代码 | 必填；1-50 字；建议允许英文、数字、短横线、下划线 |
| 生成单位 | 必填；1-100 字 |
| 库房 | 必填；1-50 字 |
| 入库人 | 必填；1-30 字 |
...
1. `formLoading = true`。
2. 根据行记录查询详情。
3. 回填“选择模板”、“备注”、“材料代码”、“生成单位”、“库房”、“入库人”、“容器号”、“入库时间”、“二维码”。
4. 设置所有表单项只读，仅保留关闭按钮。
5. `formLoading = false`。
